...
- *(macos)* kinetic rubber-band scroll in prefs
- *(macos)* auto-relaunch on Accessibility grant
- *(macos)* prefs Dock, native scroll, Docker UX

### Other

- *(macos)* ship the rubber-band scroll in the prebuild

## [0.4.0](https://github.com/jondkinney/hyprcorrect/compare/v0.3.0...v0.4.0) - 2026-06-05

### Added

- *(macos)* add macOS platform backend

## [0.3.0](https://github.com/jondkinney/hyprcorrect/compare/v0.2.6...v0.3.0) - 2026-06-05

### Fixed

- harden correction emit + review popup UX

## [0.2.6](https://github.com/jondkinney/hyprcorrect/compare/v0.2.5...v0.2.6) - 2026-06-04

### Fixed

- *(scroll)* mouse wheel no longer triggers kinetic over-scroll
